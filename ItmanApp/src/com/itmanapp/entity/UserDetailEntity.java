...
public class UserDetailEntity {
	 ...
	 * @return the tuiSex
	 */
	public int getTuiSex() {
		return tuiSex;
	}
	/**
	 * @param tuiSex the tuiSex to set
	 */
	public void setTuiSex(int tuiSex) {
		this.tuiSex = tuiSex;
	}
	/**
	 * @return the tuiTitle
	 ...
	 */
	public int getTuiRoleId() {
		return tuiRoleId;
	}
	/**
	 * @param tuiRoleId the tuiRoleId to set
	 */
	public void setTuiRoleId(int tuiRoleId) {
	 ...
	 */
	public long getTuiAddDate() {
		return tuiAddDate;
	}
	/**
	 * @param tuiAddDate the tuiAddDate to set
	 */
	public void setTuiAddDate(long tuiAddDate) {
