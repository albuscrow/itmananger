 ...
 * 
 */
public class RepairAcceptanceActivity  extends BaseActivity implements OnItemClickListener,OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_repair_acceptance);
	...
	private void getView() {
		...
		mDialog = new ProgressDialog(RepairAcceptanceActivity.this);
		...
		adapter=new RepairAcceptanceAdatper(RepairAcceptanceActivity.this, listAll);
			...
			JsonObjectRequest req = new JsonObjectRequest(Method.GET, url,
					new JSONObject(params), new Listener<JSONObject>() {
						...
						public void onResponse(JSONObject response) {
							...
							list=GetRepairAcceptanceJson.getJson(response.toString());
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
			case 1:
				//Toast.makeText(RepairAcceptanceActivity.this, "获取成功", 1000).show();
				
				break;
			case -1:
				Toast.makeText(RepairAcceptanceActivity.this, "验证不通过，非法用户", 1000).show();
				break;
			case 0:
				Toast.makeText(RepairAcceptanceActivity.this, "获取失败", 1000).show();
				break;
			case 103:
				Toast.makeText(RepairAcceptanceActivity.this, "参数错误", 1000).show();
				break;
			}
			// 关闭ProgressDialog
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		Intent intent=new Intent(RepairAcceptanceActivity.this,RepairAcceptanceDetailActivity.class);
	...
	private void initSetPullLoad() {
		...
		// 判断是否加载上拉加载更多
		count = GetRepairAcceptanceJson.total;
	...
	private void refreshAndLoad() {
		...
		warrantyLv.setXListViewListener(new IXListViewListener() {
			...
			public void onLoadMore() {
				if (NetworkCheck.check(RepairAcceptanceActivity.this) != null) {
					if (!flag) {
	...
	private Handler myHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0X001:
				listAll.clear();
				refreshAndLoad();
				Toast.makeText(RepairAcceptanceActivity.this,
