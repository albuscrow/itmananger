...
public class FillRepairEntity {
	...
	public String toString() {
		return "FillRepairEntity [asChargePhone=" + asChargePhone + ", swName="
				+ swName + ", asId=" + asId + ", auiName=" + auiName
				+ ", systemPhone=" + systemPhone + ", asAddress=" + asAddress
				+ ", asName=" + asName + ", systemPerspm=" + systemPerspm
