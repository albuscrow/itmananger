...
public class CheckListActivity extends Activity implements OnClickListener,OnItemClickListener {
	...
	private void getView() {
		mDialog = new ProgressDialog(CheckListActivity.this);
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				adapter=new RelatedCabinetAdatper(CheckListActivity.this, cabinetList);
				relatedDeviceLv.setAdapter(adapter);
				break;
			case -1:
				Toast.makeText(CheckListActivity.this, "验证不通过，非法用户", 1000).show();
				break;
			case 0:
				Toast.makeText(CheckListActivity.this, "获取失败", 1000).show();
				break;
			case 103:
				Toast.makeText(CheckListActivity.this, "参数错误", 1000).show();
				break;
			}
			// 关闭ProgressDialog
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		Intent resultIntent = new Intent(CheckListActivity.this, RelatedDeviceActivity.class);
