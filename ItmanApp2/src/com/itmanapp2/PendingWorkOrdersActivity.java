...
//		setContentView(R.layout.activity_pending_work_orders);
...
//		mDialog = new ProgressDialog(PendingWorkOrdersActivity.this);
//		mDialog.setMessage(getString(R.string.login_msg));
//		
//		backBtn=(ImageView)findViewById(R.id.backBtn);
//		backBtn.setOnClickListener(this);
//		
//		workOrderLv=(XListView)findViewById(R.id.workOrderLv);
//		workOrderLv.setOnItemClickListener(this);
//		adapter=new WorkOrderAdatper(PendingWorkOrdersActivity.this, listAll);
//		workOrderLv.setAdapter(adapter);
//		
...
//			switch (msg.what) {
//			case 1:
//				//Toast.makeText(PendingWorkOrdersActivity.this, "获取成功", 1000).show();
//				break;
//			case -1:
//				Toast.makeText(PendingWorkOrdersActivity.this, "验证不通过，非法用户", 1000).show();
//				break;
//			case 0:
//				Toast.makeText(PendingWorkOrdersActivity.this, "获取失败", 1000).show();
//				break;
//			case 103:
//				Toast.makeText(PendingWorkOrdersActivity.this, "参数错误", 1000).show();
//				break;
//			}
//			// 关闭ProgressDialog
...
//
//			workOrderLv.setPullLoadEnable(false);
//
//		} else {
//
//			workOrderLv.setPullLoadEnable(true);
//		}
//	}
//
//	/**
...
//
//		workOrderLv.setPullRefreshEnable(true);
//		workOrderLv.setXListViewListener(new IXListViewListener() {
//
//			@Override
...
//				if (NetworkCheck.check(PendingWorkOrdersActivity.this) != null) {
//					if (!flag) {
//
//						flag = true;
//						// 改变更新标识
...
//				listAll.clear();
//				refreshAndLoad();
//				Toast.makeText(PendingWorkOrdersActivity.this,
