...
public class CheckPlanActivity extends Activity implements
	...
	private void getView() {
		mDialog = new ProgressDialog(CheckPlanActivity.this);
		...
		adapter = new InspectionPlanAdatper(CheckPlanActivity.this,
				listAll);
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				break;
			case 103:
				Toast.makeText(CheckPlanActivity.this, "参数错误", 1000)
						.show();
				break;
			}
			// 关闭ProgressDialog
	...
	private void initSetPullLoad() {
		...
		// 判断是否加载上拉加载更多
		count = GetInspectionPlanJson.total;
	...
	private void refreshAndLoad() {
		...
		inspectionSystemPlanLv.setXListViewListener(new IXListViewListener() {
			...
			public void onLoadMore() {
				if (NetworkCheck.check(CheckPlanActivity.this) != null) {
					if (!flag) {
	...
	private Handler myHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0X001:
				listAll.clear();
				refreshAndLoad();
				Toast.makeText(CheckPlanActivity.this,
